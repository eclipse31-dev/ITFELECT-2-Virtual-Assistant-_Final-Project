...
const items = [
  ...
  { date: '2023 – Present', title: 'Technical Officer', org: 'VIBE — Virtual Initiative for Building Engagement Club', desc: 'Serving as Technical Officer for VIBE, handling technical operations, equipment setup, and digital support for club events and activities.' },
  { date: '2024 – 2025', title: 'Former Technical Officer', org: 'GDGOC — Google Developer Group on Campus', desc: 'Served as Technical Officer for the Google Developer Group on Campus, supporting technical workshops, developer events, and community-driven tech initiatives.' },
